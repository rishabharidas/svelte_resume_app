...
export declare type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is basic_details]": $.LinkDesc<_default.$basic_details, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is address]": $.LinkDesc<_default.$address, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is certifications]": $.LinkDesc<_default.$certifications, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is education]": $.LinkDesc<_default.$education, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is languages]": $.LinkDesc<_default.$languages, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is skills]": $.LinkDesc<_default.$skills, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is social_media]": $.LinkDesc<_default.$social_media, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is work_experience]": $.LinkDesc<_default.$work_experience, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is projects]": $.LinkDesc<_default.$projects, $.Cardinality.Many, {}, false, false,  false, false>;
